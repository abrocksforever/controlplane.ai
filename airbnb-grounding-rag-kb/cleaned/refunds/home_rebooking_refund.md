---
document_id: home_rebooking_refund
title: Rebooking and refund policy for homes
category: refund
product: home
audience: guest_host
region: global
source: Airbnb Help Center
source_url: https://www.airbnb.com/help/article/2868
...
If a host cancels a home reservation before check-in, the guest is entitled to a full refund and Airbnb may help find a similar place depending on availability. Airbnb may convert the original payment to travel credit for immediate rebooking, but the guest can request the original payment method instead; unused travel credit is refunded after 72 hours. Reservation Issues generally must be reported within 72 hours of discovery. Covered issues include host cancellation, failure to provide access, uninhabitable accommodations, and material differences from the listing. This policy controls when it applies.

# What happens if a host cancels before check-in

If a host cancels a reservation prior to check-in, their guest is entitled to a full refund, and where appropriate, Airbnb will help the guest find a similar place, depending on availability at comparable pricing.

Airbnb will generally convert the guest's original payment into a travel credit to facilitate immediate rebooking, but guests can always request a refund to their original payment method instead. If the travel credit is unused after 72 hours, the amount of the credit will be refunded to the guest’s original payment method.
...
Inaccurate space type (ex: entire place, private room, or shared room).
Inaccurate type or number of rooms (ex: bedrooms, bathrooms, and kitchens).
...
Special amenity or feature advertised in the Listing is not present or does not function (ex: pool, hot tub, major appliance, heating, and air conditioning systems).
